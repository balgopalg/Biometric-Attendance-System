...
- Workflow payloads and validation: [/docs/governance/API_WORKFLOW_GUIDE.md](../governance/API_WORKFLOW_GUIDE.md)
- Full operations manual: [/docs/operations/SYSTEM_OPERATIONS_MANUAL.md](SYSTEM_OPERATIONS_MANUAL.md)