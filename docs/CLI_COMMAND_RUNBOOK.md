...
- Workflow payloads and validation: [docs/API_WORKFLOW_GUIDE.md](docs/API_WORKFLOW_GUIDE.md)
- Full operations manual: [docs/SYSTEM_OPERATIONS_MANUAL.md](docs/SYSTEM_OPERATIONS_MANUAL.md)