...
- Functional operations manual: [docs/SYSTEM_OPERATIONS_MANUAL.md](docs/SYSTEM_OPERATIONS_MANUAL.md)
- Command runbook: [docs/CLI_COMMAND_RUNBOOK.md](docs/CLI_COMMAND_RUNBOOK.md)