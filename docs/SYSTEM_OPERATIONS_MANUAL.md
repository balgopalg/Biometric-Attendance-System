...
- Workflow payload handbook: [docs/API_WORKFLOW_GUIDE.md](docs/API_WORKFLOW_GUIDE.md)
- CLI runbook for all operations commands: [docs/CLI_COMMAND_RUNBOOK.md](docs/CLI_COMMAND_RUNBOOK.md)